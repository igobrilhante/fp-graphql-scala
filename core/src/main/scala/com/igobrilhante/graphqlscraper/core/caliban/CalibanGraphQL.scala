...
import com.igobrilhante.graphqlscraper.core.entities.{GraphQLApiQuery, News}
...
object CalibanGraphQL {
  ...
  def impl(repository: NewsRepository[Task], stream: NewsSubscription[ZStream, Any, Nothing, News]): GraphQL[Task] =
    new GraphQL[Task] {
